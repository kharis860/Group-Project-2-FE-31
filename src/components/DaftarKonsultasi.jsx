...
function DaftarKonsultasi() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then((res) => {
        console.log(res);
        // alert("Pasien sudah terdaftar untuk konsultasi");
      })
      .catch((err) => {
        console.log(err);
      });
        ...
        <section className="row ">
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="input-group flex-nowrap">
                  <input type="text" className="form-control" placeholder="Cari berdasarkan ID Pasien atau Nama" id="inputSearch" onChange={(e) => handleSearch(e.target.value)} value={inputSearch} />
          ...
          <div className="daftar">
            <form onSubmit={handleSubmit}>
              ...
              <input type="text" id="pasien" name="pasien" className="inputText" value={inputPasien} onChange={(e) => setInputPasien(e.target.value)} placeholder="Masukkan ID Pasien" />
              <label htmlFor="poli">
                <strong>Poli</strong>
              </label>
              <div className="radio">
              ...
              <select name="dokter" id="dokter" value={inputDokter} onChange={(e) => setInputDokter(e.target.value)}>
